...
console.log(! isNaN(cp));
    ...
    for (let index = 0; index <  campocity.value.length; index++) {
        ...
        if ( (
                (campocity.value.toUpperCase().charCodeAt(index)<65)
                ||
                (campocity.value.toUpperCase().charCodeAt(index)>90)
            ) 
            && 
            ((campocity.value.toUpperCase().charCodeAt(index)!=32)) //espacio
            && ((campocity.value.toUpperCase().charCodeAt(index)!=193)) //á
            && ((campocity.value.toUpperCase().charCodeAt(index)!=201)) //é
            && ((campocity.value.toUpperCase().charCodeAt(index)!=205)) //í
            && ((campocity.value.toUpperCase().charCodeAt(index)!=211)) //ó
            && ((campocity.value.toUpperCase().charCodeAt(index)!=218)) //ú
            && ((campocity.value.toUpperCase().charCodeAt(index)!=209)) //ñ

            &&((campocity.value.length >= 3))
            &&((campocity.value.length <= 20)) 
