...
boton1.addEventListener("click", function (e) {
  ...
  //numero1//////
    ...
    { numero2class.classList.remove("is-valid");
    numero2class.classList.add("is-invalid");

} else if (numero3 >= 100)
    { numero3class.classList.remove("is-valid");
    numero3class.classList.add("is-invalid");
